...
export const darkModeBtn = document.querySelector('#dark-mode-text');
export const lightModeBtn = document.querySelector('#light-mode-text');

export const darkModeIco = document.querySelector('#dark-mode-btn');
export const lightModeIco = document.querySelector('#light-mode-btn');

export const tasksdashboardTitle = document.querySelector('h1');
export const tasksDashboardArea = document.querySelector('#tasks-dashboard');